...
export const readItemsQueryKey = (options?: Options<ItemsReadItemsData>) =>
...
export const createItemQueryKey = (options: Options<ItemsCreateItemData>) =>
...
export const deleteItemMutation = (
  ...
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await ItemsService.deleteItem({
        ...options,
        ...localOptions,
        throwOnError: true,
      })
...
export const readItemQueryKey = (options: Options<ItemsReadItemData>) =>
  createQueryKey("itemsReadItem", options)

export const readItemOptions = (options: Options<ItemsReadItemData>) => {
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await ItemsService.readItem({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
